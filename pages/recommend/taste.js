function random_show_spicy() {
  var random;
  var src_img = [
    'https://firebasestorage.googleapis.com/v0/b/hekaton-be17b.appspot.com/o/spicy1.jpg?alt=media&token=234ef7e6-b7ba-4912-a0b5-15804f7641b3',
  ...
  document.getElementById('food_img1').src = src_img[0];
  document.getElementById('food_name1').innerHTML = src_name[0];
  random = Math.floor(Math.random() * 3);
  document.getElementById('food_img2').src = src_img[1];
  document.getElementById('food_name2').innerHTML = src_name[1];
  random = Math.floor(Math.random() * 3);
  document.getElementById('food_img3').src = src_img[2];
  document.getElementById('food_name3').innerHTML = src_name[2];
  console.log(random);
}
function random_show_savory() {
  var random;
  var src_img = [
    'https://firebasestorage.googleapis.com/v0/b/hekaton-be17b.appspot.com/o/savory1.jpg?alt=media&token=7e4ba19e-f64c-486a-89f8-1eed64e6482d',
...
function random_show_sweet() {
  var random;
  var src_img = [
    'https://firebasestorage.googleapis.com/v0/b/hekaton-be17b.appspot.com/o/sweet1.jpg?alt=media&token=1898793c-ccc2-451e-ae10-6f42a2b02450',
